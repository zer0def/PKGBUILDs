...
arch=('x86_64')
license=('GPL3')
depends=('libx11' 'dbus-glib' 'libusb' 'python-dbus' 'systemd')
makedepends=('scons' 'boost' 'pkg-config' 'libx11' 'python')
backup=("etc/default/xboxdrv")
source=(
  "${pkgname}-${pkgver}.tar.gz::https://github.com/xboxdrv/${pkgname}/archive/v${pkgver}.tar.gz"
  "xboxdrv.service"
  "xboxdrv.default"
...
sha512sums=(
  '3f27856da211a14e27a84fa5919da7965262adc36da16c75eed9bae891098183b5751a3e707573b4ab64e69096ea74d455e8f64827c88b38b65af94cc13b34ad'
  ...
  '799038feb1b7672cbb2dd4208ab34ff54577a532053896e9d828cda445215fa3b649687b3a5f7d4da57b169810b686c8b495bd120143a28279d0efebb14c6929'
)
...
prepare() {
  ...
  patch -p1 < "${srcdir}/xboxdrv-py3.patch"
}
